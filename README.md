...
Create custom query
In the custom query sectin seach for event.action
Under the about rule section type nmap scan
The rule actions section select the connector type 
Select email then create & enable rule
